...
A = [7, 19]			#Each Stepper Motor has 4 Wireslots  
B = [11,21]			# represented by the lists A,B,C,D
C = [13, 23]		# Slot 1 is A, Slot 2 is B... 
D = [15, 29]		#4 Motors, so 4 elements in each list. (soon)
pins= [A,B,C,D]
